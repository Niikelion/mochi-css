...
const LeftContent: FC = () => (
    <LeftGrid>
        <JP vertical color="dim" style={{ gridArea: "side" }}>
            レイアウト
        </JP>
        <Wordmark style={{ gridArea: "top" }}>
            Mochi<span>.css</span>
        </Wordmark>
        <SubLabel style={{ gridArea: "sub" }}>/ bento</SubLabel>
        <Rule style={{ gridArea: "rule" }} />
        <Tagline style={{ gridArea: "tag" }}>
            layout primitives &nbsp;—&nbsp; <strong>compile-time</strong>
            <br />
