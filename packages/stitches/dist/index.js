...
function runtimeStyled(target, args, config) {
	...
	function StitchesComponent(props) {
		...
		const allClassNames = (0, clsx.default)(variantClassName, dynamicStyles.map((s) => s.className), className);
		const styleElements = dynamicStyles.map((s) => (0, react.createElement)("style", {
			key: s.className,
			href: s.className,
			precedence: "medium"
		}, s.css));
		const element = asProp ?? renderTarget;
		return (0, react.createElement)(react.Fragment, null, ...styleElements, (0, react.createElement)(element, {
...
//#endregion
exports.buildThemeClassName = buildThemeClassName;
exports.buildThemeRefs = buildThemeRefs;
exports.createStitches = createStitches;
exports.defaultThemeMap = defaultThemeMap;
exports.expandBreakpoint = expandBreakpoint;
