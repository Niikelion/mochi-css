...
import { idToRef, isLocalImport, type Ref } from "@/analysis/helpers"
import { StyleExprStage, makeStyleExprStage, type StyleExprStageOut } from "@/analysis"
...
export const BindingStage = makeBindingStage(StyleExprStage)
