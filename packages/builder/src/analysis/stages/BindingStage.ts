...
import type { BindingInfo, BindingDeclarator, LocalImport, DerivedExtractorBinding } from "@/analysis/types"
import { idToRef, isLocalImport } from "@/analysis/helpers"
...
type BindingStageResult = {
    ...
    exports: Map<string, import("@/analysis/helpers").Ref>
    exportedDerivedExtractors: Map<string, DerivedExtractorBinding>
}

export const BindingStage = defineStage({
    dependsOn: [StyleExprStage],
    init(registry: CacheRegistry, styleExprInst: ReturnType<typeof StyleExprStage.init>) {
        const fileBindings = registry.fileCache(
            ...
            (file): BindingStageResult => {
                ...
                const exports = new Map<string, import("@/analysis/helpers").Ref>()
                ...
                return { moduleBindings, localImports, references, exports, exportedDerivedExtractors }
            },
        )
